...
$project = Join-Path $root "src\IGoLibrary.Ex.Android\IGoLibrary.Ex.Android.csproj"
...
$publishDirectory = Join-Path $root "src\IGoLibrary.Ex.Android\bin\$Configuration\net10.0-android\publish"
