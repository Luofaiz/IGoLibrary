...
<p align="center">
  ...
  <img src="https://img.shields.io/github/v/release/Luofaiz/IGoLibrary?logo=github" alt="Latest Release" />
  <img src="https://img.shields.io/github/license/Luofaiz/IGoLibrary" alt="License" />
</p>
...
该流程会生成并上传 `IGoLibrarySetup.exe`、`latest.json` 和 `IGoLibrary-Windows-x64.zip`。桌面端会检查：
